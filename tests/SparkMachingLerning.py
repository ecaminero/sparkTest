...
get_ipython().system(u'head -n 3 /user/cloudera/Mlib/data_sample(Transformacion ML).txt')


# In[3]:


data = sc.textFile("/user/cloudera/Mlib/data_sample(Transformacion ML).txt")
